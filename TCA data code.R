...
ggplot(Datam, aes(fill=Date, y=Datam$`Employment level` ,x=Year)) + 
  ...
  scale_fill_manual(name='Energy industry',values=c('#003f5c','#374c80','#7a5195','#bc5090','#ef5675','#ff764a','#ffa600'))
...
##The following is not my 200 word commentary,it is in my github folder##
